class PersonasController < ApplicationController
  ...
  def index
    @personas = Persona.order(Arel.sql("strftime('%m', fecha_nacimiento)"))  #Arel.sql es para especificar que la consulta es conocida y segura
  end
  ...
  private
    ...
    def persona_params
      params.require(:persona).permit(:nombre, :apellido, :fecha_nacimiento, :nro_dni)
    end
end
